...
import { TrackDirection } from '../../src/types/trackMap';
...
export const findDirection = (trackId: number): TrackDirection => {
  if (
    [
    ...
    return TrackDirection.ANTICLOCKWISE;
  }

  return TrackDirection.CLOCKWISE;
};

export const getSvgDom = (svgContent: string) => {
